...
public class AsyncServlet extends HttpServlet {
    ...
    private void execute(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        builder.append("<!DOCTYPE html>")
                ...
                .append("p span.head{background-color : #ccf; width : 300px; margin-right : 10px; margin-top : 10px; margin-bottom : 10px; padding : 10px; border-radius : 10px;}")
                .append('\n')
        ...
        builder.append(PE)
                ...
                .append("date=y+'/'+(M<10?'0':'')+M+'/'+d+' '+h+':'+(m<10?'0':'')+m+':'+s+'.'+S;")
                .append("document.getElementById('now').innerText=date;")
                .append("};")
                .append("</script>")
                .append("</footer>")
                .append("</body>")
